...
class RecentlyPlayedVideoPageDesign extends StatefulWidget {
  const RecentlyPlayedVideoPageDesign(
      {super.key, required this.songName});
  final String songName;
  @override
  State<StatefulWidget> createState() {
    return _RecentlyPlayedVideoPageDesignState();
  }
}

class _RecentlyPlayedVideoPageDesignState extends State<RecentlyPlayedVideoPageDesign> {
